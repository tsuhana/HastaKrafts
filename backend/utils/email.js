...
const baseStyles = `
  ...
  .content { background: #FFF8DC; padding: 30px; border-radius: 0 0 10px 10px; }
  .content h2 { margin-top: 0; color: #2C1810; }
  .footer { text-align: center; margin-top: 20px; color: #78716C; font-size: 12px; }
  .btn {
    display: inline-block; margin: 18px 0; padding: 12px 28px;
  ...
  const mailOptions = {
    ...
    html: `
      <!DOCTYPE html><html><head><style>${baseStyles}
        .otp-box {
          background: white; border: 3px dashed #D4813F; padding: 20px;
          text-align: center; font-size: 32px; font-weight: bold;
          letter-spacing: 8px; margin: 20px 0; color: #D4813F; border-radius: 10px;
        }
        .warning { color: #DC2626; font-weight: bold; margin: 15px 0; }
      </style></head>
      <body>
        <div class="container">
          <div class="header"><h1>HastaKrafts Nepal</h1><p>Password Reset Request</p></div>
          <div class="content">
            <h2>Hello!</h2>
...
const sendSellerApprovalEmail = async (email, sellerName, shopName) => {
  ...
  const mailOptions = {
    ...
    html: `
      <!DOCTYPE html><html><head><style>${baseStyles}
        ...
        .steps { background: white; border-radius: 8px; padding: 16px 22px; margin: 16px 0; }
        .steps li { margin: 8px 0; color: #2C1810; font-size: 14px; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <center>
              <a href="${dashboardUrl}" class="btn btn-approve">Go to Seller Dashboard</a>
            </center>
  ...
  try {
    ...
    // Don't throw — approval already happened, email is secondary
  }
};
...
const sendSellerRejectionEmail = async (email, sellerName, shopName, rejectionReason) => {
  ...
  const mailOptions = {
    ...
    html: `
      <!DOCTYPE html><html><head><style>${baseStyles}
        .reason-box {
          background: #FFF7ED; border-left: 4px solid #D4813F;
          border-radius: 0 8px 8px 0; padding: 14px 18px; margin: 20px 0;
          color: #2C1810;
        }
        .reason-box strong { display: block; margin-bottom: 6px; color: #9A3412; }
        .tips { background: white; border-radius: 8px; padding: 16px 22px; margin: 16px 0; }
        .tips li { margin: 8px 0; color: #2C1810; font-size: 14px; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>
              Thank you for applying to sell on HastaKrafts Nepal. After reviewing your
              application for <strong>"${shopName}"</strong>, we were unable to approve it
              at this time.
            </p>
            ...
            <p>Don't be discouraged — you're welcome to re-apply after addressing the feedback above.</p>
            <div class="tips">
              <p style="margin:0 0 8px; font-weight:700; color:#2C1810;">Tips for a successful application:</p>
              <ul>
            ...
            <center>
              <p class="btn btn-reapply">Re-apply as Seller</a>
            </center>
            <p style="color:#78716C; font-size:13px;">
  ...
  try {
    ...
    // Don't throw — rejection already happened, email is secondary
  }
};

module.exports = { sendOTPEmail, sendSellerApprovalEmail, sendSellerRejectionEmail };